...
"""
Osmo Game AI: Layer 2 parameter tuning

Author: Zhenyu He (GitHub: jobsstroustrup)
Role: Designed and implemented the Layer 2 parameter-tuning variant.

This module shares the search skeleton with hzy3.py (Layer 1) but explores
alternative hyperparameters for sensitivity analysis:
  Time-unit alignment (relative_veloc * FRAME_DELTA vs plain relative_veloc)
  Acceleration discretization precision
  Temporal decay factor (j = 0.94 vs 0.97 for long-pursuit preference)
  Total-time cutoff toggling

Layer 2 demonstrates A/B-testing methodology applied to game AI parameters,
treating tuning as a systematic experimental process. The variant in this
file is the author's own iteration, kept alongside hzy3.py for comparison
of how parameter choices affect tournament performance.

Tournament context: this AI configuration was part of the team's submission
that placed 2nd in the SESSDSA 2019 Spring course tournament.
