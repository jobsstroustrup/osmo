...
"""
Osmo Game AI: Layer 3 strategy orchestration

Author: Zhenyu He (GitHub: jobsstroustrup)
Role: Designed and implemented the high-level strategy orchestration layer.

Layer 3 wraps the Layer 1/2 search mechanisms into a coherent game strategy
integrating:
  Reactive hazard avoidance (priority: detect threats, abort plans, escape)
  Deliberative goal planning (when safe: search, filter candidates, verify, execute)
  Density-adaptive search radius (crowded: r=100, sparse: r=800)
  Cost-benefit filtering (do not chase prey smaller than ejection-cost ROI)
  Stateful execution with mid-plan abort (collision_group triggers reset)

Architectural inspiration:
  Brooks (1986) subsumption architecture: lower-priority behaviors suppress higher
  Boyd OODA loop (Observe, Orient, Decide, Act) embedded in strategy() main loop
  Game AI best practice: always validate safety before committing to plans

Tournament context: 2nd place in SESSDSA 2019 Spring course tournament.
